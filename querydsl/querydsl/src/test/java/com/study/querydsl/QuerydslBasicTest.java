...
public class QuerydslBasicTest {
    ...
    public void paging() {
        List<Member> result = queryFactory
                ...
                // 몇 번째 부터 skip 할 건지, 0부터 시작 offset(1) 은 1부터 skip한다는 의미,,
                .offset(1)
                .limit(2)
                .fetch();
    ...
    /**
     * theta_join, 연관 관계가 없어도 join이 가능
    ...
    /**
     * projection 대상이 하나인 것 == select 절에 나열하는 항목이 하나
     */
    @Test
    public void smipleProjection() {
        List<String> result = queryFactory
                .select(member.username)
                .from(member)
                .fetch();
    ...
    /**
     * @Getter, @Setter 없이 field 에 값이 바로 찍히는 방법
     */
    @Test
